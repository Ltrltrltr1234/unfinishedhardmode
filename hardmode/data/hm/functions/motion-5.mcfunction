...
execute facing entity @p feet run tp @s ^ ^0.05 ^0.1
...
execute store result entity @s Motion[0] double 0.04 run scoreboard players operation @s motionx2 -= @s motionx1
execute store result entity @s Motion[1] double 0.01 run scoreboard players operation @s motiony2 -= @s motiony1
execute store result entity @s Motion[2] double 0.04 run scoreboard players operation @s motionz2 -= @s motionz1