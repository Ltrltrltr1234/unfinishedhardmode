...
execute store result entity @s Motion[0] double 0.05 run scoreboard players operation @s motionx2 -= @s motionx1
execute store result entity @s Motion[2] double 0.05 run scoreboard players operation @s motionz2 -= @s motionz1
